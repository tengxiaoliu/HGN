...
import utils.keg_utils as gg
from utils.keg_utils import Example
...
def read_hotpot_examples(para_file,
    ...
    for case in tqdm(raw_data[:100]):
        ...
        nodes, edges, sent_nodes = gg.build_graph_hotpot(ctx_text_list, question_text)
...
if __name__ == '__main__':
    ...
    cached_examples_file = os.path.join(args.output_dir,
                                        get_cached_filename('examples_1202', args))
